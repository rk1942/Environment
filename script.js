...
$consumption.onclick = () =>{
    ...
    $resources.style.backgroundColor = "transparent"
    $people.style.backgroundColor = "transparent"
    document.getElementById("save").innerHTML = "Do your bit! Shop only what you need, eat only what you need, and always save leftovers"
...
$people.onclick = () =>{
    ...
    $resources.style.backgroundColor = "transparent"
    $climate.style.backgroundColor = "transparent"
    document.getElementById("save").innerHTML = "Do your bit! never waste food, Rather offer it to people and animals in need"
